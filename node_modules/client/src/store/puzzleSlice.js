...
// Load today's puzzle
export const loadTodaysPuzzle = createAsyncThunk('puzzle/loadTodays', async (_, { rejectWithValue }) => {
    try {
...
// Submit answer
export const submitAnswer = createAsyncThunk('puzzle/submitAnswer', async (userAnswer, { getState, rejectWithValue }) => {
    try {
