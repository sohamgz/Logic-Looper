...
// Async thunks
export const loginGoogle = createAsyncThunk('auth/loginGoogle', async (_, { rejectWithValue }) => {
    try {
...
export const loginTruecaller = createAsyncThunk('auth/loginTruecaller', async (_, { rejectWithValue }) => {
    try {
