...
export const BinaryPuzzle = ({ gates, onSubmit }: Props) => {
  const [answers, setAnswers] = useState<boolean[]>(gates.map(() => false));
  ...
  const getGateSymbol = (gate: string) => {
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-16 h-16 rounded-lg flex items-center justify-center font-bold text-white text-2xl transition-all ${
